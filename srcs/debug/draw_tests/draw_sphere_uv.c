...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/07 16:43:21 by nryser            #+#    #+#             */
/*   Updated: 2025/05/07 16:43:21 by nryser           ###   ########.ch       */
/*                                                                            */
/* ************************************************************************** */
...
// 	// 🎨 UV patt: checkerboard wrapping the sphere
// 	patt = malloc(sizeof(t_patt));
// 🔁 change this to uv_stripe_patt(), uv_gradient_patt(), uv_checkers_patt().
// 	*patt = uv_gradient_patt(
